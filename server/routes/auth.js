...
// @route  POST /api/auth/register-user  (inscription publique grand public)
router.post(
  '/register-user',
  [
    body('name').notEmpty().withMessage('Le nom est requis'),
...
// @route  POST /api/auth/heartbeat  (marque l'utilisateur en ligne)
...
// @route  POST /api/auth/offline  (marque l'utilisateur hors ligne)
