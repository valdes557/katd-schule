...
const schoolPostSchema = new mongoose.Schema(
  {
    ...
    type: { type: String, enum: ['text', 'photo', 'video', 'audio', 'youtube'], default: 'text' },
    ...
    // Publication d'une vidéo YouTube partagée (type 'youtube') — lecteur intégré, métadonnées uniquement.
